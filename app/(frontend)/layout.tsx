	...
	return (
		<>
			...
			<div className={`${styles.grid}`}>
				...
				<div className="max-md:flex gap-4 max-md:pt-4 flex-col items-center md:border-r bg-dark-purple border-black relative max-md:row-start-3 max-w-full max-h-full">
					<FrontendLayoutNav />
