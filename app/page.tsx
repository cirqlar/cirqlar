...
export default function Home() {
  const [current, setCurrent] = useState(0);
	...
	return (
		<main className={`${styles.main} w-full h-full overflow-clip relative p-10 md:p-20 md:flex md:flex-col md:justify-between`}>
			<div className="">
			...
			>
				<div className={styles.nav_images}>
					<div className={styles.nav_center_wrapper}>
						{/* Nav Center */}
						<div className={`${styles.nav_center} text-opacity-40 dark:text-opacity-40 text-slate-900 dark:text-slate-100`}>
							<AILogo />
						</div>
					</div>
				</div>
